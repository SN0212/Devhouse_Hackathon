...
class IoTScanner:
    ...
    def test_authentication(self, payload, description):
        ...
        try:
            ...
            if b'login' not in response.lower() and b'fail' not in response.lower():
    ...
    def test_buffer_overflow(self, payload, description):
        ...
        try:
            ...
            if not response or b'crash' in response.lower() or b'reboot' in response.lower():
                self.log_vulnerability(
                    "Buffer Overflow",
    ...
    def test_secure_boot_bypass(self, payload, description):
        ...
        try:
            ...
            if b'verified' in response.lower() or b'signature' not in response.lower():
                self.log_vulnerability(
                    "Secure Boot Bypass",
